...
const { generateDoubleRoundRobinFixtures, computeStandings, getCompletionStats, getTodayISO, getLeaguePointRules, normalizePointRules } = require('./league');
...
client.on(Events.InteractionCreate, async (interaction) => {
  try {
    ...
    if (interaction.isChatInputCommand()) {
      ...
      if (name === 'table') {
        const pages = buildStandingsTablePages();
